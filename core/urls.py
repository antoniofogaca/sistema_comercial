...
urlpatterns = [
    ...
    path('convenio/', views.convenio_emissao_list, name='convenio_emissao_list'),
    path('convenio/novo/', views.convenio_emissao_create, name='convenio_emissao_create'),
    path('convenio/editar/<int:pk>/', views.convenio_emissao_update, name='convenio_emissao_update'),
    path('convenio/excluir/<int:pk>/', views.convenio_emissao_delete, name='convenio_emissao_delete'),
    path('convenio/confirmar-exclusao/<int:pk>/', views.convenio_emissao_confirm_delete, name='convenio_emissao_confirm_delete'),
    # ... outras URLs
    ...
    # ...
    # Módulo de Convênios
    path('convenio/', views.convenio_list, name='convenio_list'),
    path('convenio/novo/', views.convenio_create, name='convenio_create'),
    path('convenio/editar/<int:pk>/', views.convenio_update, name='convenio_update'),
    path('convenio/excluir/<int:pk>/', views.convenio_delete, name='convenio_delete'),
    path('convenio/confirmar-exclusao/<int:pk>/', views.convenio_confirm_delete, name='convenio_confirm_delete'),

    # NOVAS URLs para Abertura de Convênio
    ...
    path('ncm/excluir/<int:pk>/', views.ncm_delete, name='ncm_delete'),  # Esta URL é para o POST de exclusão
    path('ncm/confirmar-exclusao/<int:pk>/', views.ncm_confirm_delete, name='ncm_confirm_delete'),
    # Esta é a página de confirmação

    # Módulo de Grupos (garanta que este seja o path principal para grupos)
    ...
    # Módulo de Categoria (garanta que este seja o path principal para categorias)
    ...
    # Módulo de Setores (garanta que este seja o path principal para setores)
    ...
    # Módulo de Usuários (garanta que este seja o path principal para usuários)
    path('usuarios/', views.usuario_list, name='usuarios_list'), # <-- Esta é a correta
